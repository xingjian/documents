...
/**
 * Describe class WMTSImageService here.
 *
 *
 * Created: Tue Jun 19 13:42:10 2012
 *
...
public class WMTSImageService  extends HttpServlet{
    ...
    private void response(HttpServletResponse res,byte[] data){
        ...
        try {
            ...
            String urlstr = "";
            urlstr = "http://www.beijingmap.egov.cn/service/ImageEngine/EzServerSate/EzMap?Service=getImage&Type=RGB&ZoomOffset=-2&Col="+x+"&Row="+y+"&Zoom="+z+"&V=0.3&user=sjtw01&password=sjtwxxzx01";
