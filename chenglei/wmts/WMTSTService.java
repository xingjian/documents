...
public class WMTSTService  extends HttpServlet{
    ...
    private void response(HttpServletResponse res,byte[] data){
        ...
        try {
            ...
            urlstr = "http://www.beijingmap.egov.cn/service/EzServer25D/EzMap?Service=getImage&Type=RGB&ZoomOffset=-2&Col="+x+"&Row="+y+"&Zoom="+z+"&V=0.3&user=sjtw01&password=sjtwxxzx01";
