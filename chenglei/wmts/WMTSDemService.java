...
public class WMTSDemService  extends HttpServlet{
    ...
    private void response(HttpServletResponse res,byte[] data){
        ...
        try {
            ...
            String urlstr = "";
            urlstr = "http://www.beijingmap.egov.cn/service/EzServerDEM/EzMap?Service=getImage&Type=RGB&ZoomOffset=-2&Col="+x+"&Row="+y+"&Zoom="+z+"&V=0.3&user=sjtw01&password=sjtwxxzx01";
